...
@protocol ZDProgressHUDDelegate;


typedef enum {
	/** Progress is shown using an UIActivityIndicatorView. This is the default. */
	ZDProgressHUDModeIndeterminate,
	/** Progress is shown using a round, pie-chart like, progress view. */
	ZDProgressHUDModeDeterminate,
	/** Progress is shown using a ring-shaped progress view. */
	ZDProgressHUDModeAnnularDeterminate,
	/** Shows a custom view */
	ZDProgressHUDModeCustomView,
	/** Shows only labels */
	ZDProgressHUDModeText
} ZDProgressHUDMode;

typedef enum {
	/** Opacity animation */
	ZDProgressHUDAnimationFade,
	/** Opacity + scale animation */
	ZDProgressHUDAnimationZoom
} ZDProgressHUDAnimation;


#ifndef Gome_STRONG
#if __has_feature(objc_arc)
	#define Gome_STRONG strong
#else
	#define Gome_STRONG retain
#endif
#endif

#ifndef Gome_WEAK
#if __has_feature(objc_arc_weak)//
	#define Gome_WEAK weak
#elif __has_feature(objc_arc)
	#define Gome_WEAK unsafe_unretained
#else
	#define Gome_WEAK assign
#endif
#endif

#if NS_BLOCKS_AVAILABLE
typedef void (^ZDProgressHUDCompletionBlock)();
#endif
 ...
 */
@interface ZDProgressHUD : UIView
 ...
 * @see showAnimated:whileExecutingBlock:onQueue:completion:
 */
- (void)showAnimated:(BOOL)animated whileExecutingBlock:(dispatch_block_t)block completionBlock:(ZDProgressHUDCompletionBlock)completion;
 ...
 */
@property (copy) ZDProgressHUDCompletionBlock completionBlock;
 ...
 */
@property (assign) ZDProgressHUDMode mode;
 ...
 */
@property (assign) ZDProgressHUDAnimation animationType;

/**
 * The UIView (e.g., a UIImageView) to be shown when the HUD is in MBProgressHUDModeCustomView.
 * For best results use a 37 by 37 pixel view (so the bounds match the built in indicator bounds). 
 */
@property (Gome_STRONG) UIView *customView;
 ...
 */
@property (Gome_WEAK) id<ZDProgressHUDDelegate> delegate;
 ...
 */
@property (Gome_STRONG) UIColor *color;
 ...
 */
@property (Gome_STRONG) UIFont* labelFont;

/** 
 * Font to be used for the details label. Set this property if the default is not adequate. 
 */
@property (Gome_STRONG) UIFont* detailsLabelFont;
...
@protocol ZDProgressHUDDelegate <NSObject>
 ...
 */
- (void)hudWasHidden:(ZDProgressHUD *)hud;
 ...
 */
@interface ZDRoundProgressView : UIView
