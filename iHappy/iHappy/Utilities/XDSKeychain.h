...
/**
 ...
 XDSKeychain has since switched to a simpler implementation that was abstracted from [SSToolkit](http://sstoolk.it).
 */
@interface XDSKeychain : NSObject
...
/**
 ...
 See the `NSString` constants declared in XDSKeychain.h for a list of keys that can be used when accessing the
