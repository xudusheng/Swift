...
@protocol MobiSageNativeAdDelegate<NSObject>
...
/**
 *  flexible_CLASSNAME(NativeDelegate
 *  @param delegate
 */
@property (nonatomic, assign) id<MobiSageNativeAdDelegate> delegate;
